/*1345686908,169892737,JIT Construction: v615375,en_US*/
...
__d("ES5",["ES5ArrayPrototype","ES5FunctionPrototype","ES5StringPrototype","ES5Array","ES5Object","ES5Date","JSON3"],function(a,b,c,d,e,f){
    var g=b('ES5ArrayPrototype'),h=b('ES5FunctionPrototype'),i=b('ES5StringPrototype'),j=b('ES5Array'),k=b('ES5Object'),l=b('ES5Date'),m=b('JSON3'),n=Array.prototype.slice,o=Object.prototype.toString,p={},q={
        array:g,
        'function':h,
        string:i,
        Object:k,
...
__d("Assert",["AssertionError","sprintf"],function(a,b,c,d,e,f){
    ...
    var m={
        ...
        isTrue:j,
        type:k
    },n=['Array','Boolean','Date','Function','Null','Number','Object','Regexp','String','Undefined'],o=n.length;
    while(o--){
        var p=n[o];
...
__d("Type",["copyProperties","Assert"],function(a,b,c,d,e,f){
    ...
    if(n instanceof i)for(var p=0;p<n.__mixins.length;p++)if(n.__mixins[p]==o)return true;return false;
}
var m={
    extend:j,
    mixin:k,
...
__d("sdk.Runtime",["sdk.Model","copyProperties"],function(a,b,c,d,e,f){
    var g=b('sdk.Model'),h=b('copyProperties'),i={
        UNKNOWN:0,
        PAGETAB:1,
        CANVAS:2,
        PLATFORM:4
...
__d("sdk.ErrorHandling",["UserAgent","sdk.Scribe","sdk.Runtime","wrapFunction","ManagedError","SDKConfig"],function(a,b,c,d,e,f){
    ...
    function o(t){
        ...
        for(var v in u)(u[v]==null&&delete u[v]);return u;
    }
    function p(t,u){
        return function(){
...
__d("GlobalCallback",["wrapFunction","dotAccess"],function(a,b,c,d,e,f){
    var g=b('wrapFunction'),h=b('dotAccess'),i,j,k=0,l={
...
function ea(fa,ga,ha,ia){
    for(var ja in ga)if(ha||typeof fa[ja]==='undefined')fa[ja]=ia?ia(ga[ja]):ga[ja];return fa;
}
j(u,{
    _apiKey:null,
    _authResponse:null,
...
__d("Flash",["DOMWrapper","QueryString","UserAgent","copyProperties","guid"],function(a,b,c,d,e,f){
    ...
    var s={
        embed:function(t,u,v,w){
            ...
            var y=[];
            for(var z in v)if(v.hasOwnProperty(z)&&v[z])y.push('<param name="'+encodeURI(z)+'" value="'+encodeURI(v[z])+'">');var aa=n.createElement('div'),ba='<object '+(i.ie()?'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ':'type="application/x-shockwave-flash"')+'data="'+t+'" '+'id="'+x+'">'+y.join('')+'</object>';
            aa.innerHTML=ba;
...
__d("ApiClient",["copyProperties","flattenObject","sprintf","CORSRequest","FlashRequest","JSONPRequest","Log","UrlMap","URL","ArgumentError","Assert","ApiClientConfig"],function(a,b,c,d,e,f){
    var g=b('copyProperties'),h=b('flattenObject'),i=b('sprintf'),j=b('CORSRequest'),k=b('FlashRequest'),l=b('JSONPRequest'),m=b('Log'),n=b('UrlMap'),o=b('URL'),p=b('ArgumentError'),q=b('Assert'),r=c('ApiClientConfig'),s,t,u,v,w={
        get:true,
        post:true,
        'delete':true,
        put:true
...
FB.provide('Array',{
    merge:function(a,b){
        for(var c=0;c<b.length;c++)if(ES5(a,'indexOf',true,b[c])<0)a.push(b[c]);return a;
    },
...
__d("XDM",["copyProperties","guid","DOMEventListener","DOMWrapper","Flash","Log","UserAgent"],function(a,b,c,d,e,f){
    var g=b('copyProperties'),h=b('guid'),i=b('DOMEventListener'),j=b('DOMWrapper'),k=b('Flash'),l=b('Log'),m=b('UserAgent'),n={},o={
        transports:[]
    },p=j.getWindow();
    function q(s){
...
var ka={
    ...
    init:function(la,ma){
        ...
        var oa=k.Content.appendHidden(document.createElement('div')),pa=l.create({
            root:oa,
            channel:y,
            channelPath:'/'+g.XdUrl+'#',
            ...
            whenReady:function(qa){
                ...
                var ra={
                    ...
                    transport:pa,
                    xd_name:ma
                },sa=g.XdUrl+'#'+n.encode(ra),ta=g.useCdn?k._domain.staticfb:'http://www.facebook.com/',ua=g.useCdn?k._domain.https_staticfb:'https://www.facebook.com/';
...
getByClass:function(a,b,c){
    ...
    for(var f=0,g=d.length;f<g;f++)if(this.containsCss(d[f],a))e[e.length]=d[f];return e;
},
...
setAuthResponse:function(a,b){
    ...
    var e=!FB._userID&&a,f=FB._userID&&!a,g=a&&FB._userID!=c,h=a!=FB._authResponse,i=b!=FB._userStatus,j={
        authResponse:a,
        status:b
    };
...
FB.provide('XFBML.IframeWidget',{
    ...
    batchWidgetPipeRequests:function(){
        ...
        var a=FB.XFBML.IframeWidget._groupWidgetPipeDescriptions(),b={
            ...
            locale:FB._locale,
            sdk:'joey'
        },c=FB.guid(),d=FB.XFBML.IframeWidget.masterWidgetPipeIframe.dom,e=d.appendChild(document.createElement('span'));
        FB.Content.insertIframe({
            url:'about:blank',
            root:e,
            name:c,
...
_groupWidgetPipeDescriptions:function(){
    ...
    for(var b in FB.XFBML.IframeWidget.allWidgetPipeIframes){
        var c=FB.XFBML.IframeWidget.allWidgetPipeIframes[b],d={
...
FB.subclass('Data.Query','Waitable',function(){
    ...
    parse:function(a){
        ...
        for(var d=1;d<a.length;d++)if(FB.Type.isType(a[d],FB.Data.Query))a[d].hasDependency=true;return this;
    },
    toFql:function(){
...
if(!(a in c))return false;
    for(var d in c[a])if(b[d])return false;return !FB.TemplateUI.willWriteOnGet(a,b);
},
...
_getWidgetHeight:function(){
    var a=this._getLayout(),b=this._shouldShowFaces()?'show':'hide',c=this._getBoolAttribute('send'),d=65+(c?25:0),e={
        standard:{
            show:80,
            hide:35
        },
...
_getWidgetWidth:function(){
    var a=this._getLayout(),b=this._getBoolAttribute('send'),c=this._shouldShowFaces()?'show':'hide',d=(this.getAttribute('action')==='recommend'),e=(d?265:225)+(b?60:0),f=(d?130:90)+(b?60:0),g=this.getAttribute('action')==='recommend'?100:55,h=this.getAttribute('action')==='recommend'?90:50,i={
        standard:{
            show:450,
            hide:450
        },
