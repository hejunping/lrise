<?php
	...
	return array(
		'ru'=>array(
			//焦点广告顶部
			'Customer Service'=>'Оплатить и пополнить счет',
			'Order Tutorial'=>'Доставка',
...
',
			...
			//首页热门商品底部帮助中心
			'Reliable English Taobao agent'=>'Надежный посредник Таобао',
			'Lrise.com is one of the first and most professional agents providing shopping experience on Taobao in English. We assist you with buying all kinds of products offered at incredibly low price from Taobao and other Chinese online shops.'=>'Lrise.com является одним из первого и самых профессиональных агентов, обеспечивающих опыт покупок на Taobao на английском языке. Мы поможем Вам в покупке все виды продуктов, предлагаемых в невероятно низкой цене от Taobao и других китайских интернет-магазинов.',
			'Taobao with service in English language'=>'Помощь в совершении покупок на Таобао',
			'Due to the vendors on Taobao not targeting foreign people (outside of China), Lrise.com has emerged as a shopping agent with English Taobao support. We provide Taobao products and service in English. Through us Taobao can be accessible easily by people.'=>'Сервис на русском языке позволяет осуществлять покупки легко и удобно. С помощью Lrise.com Вы сможете приобрести любые понравившиеся товары на Таобао. Оцените широчайший выбор товаров из Китая!',
			'English quality service'=>'Онлайн консультан и быстрая обработка заказов',
			'Our professional customer support provides English service to our clients on 7 days a week. The unique quick order box on the website makes buying easier and orders can be handled in 24 hours, products can arrive within 7 days.'=>'Операторы онлайн чата, работающие без выходных, помогут разобраться во всех вопросах, которые могли возникнуть у Вас в процессе совершения покупки. С помощью функции "Заказ в один клик" Вы сможете быстро оформить заказ. Ваш заказ будет обработан в течение 24 часов.',
			'Save money'=>'Экономия времени и денег',
			'Products on Taobao are sold at a lower price than in most western countries with good quality. Shopping in China is a very worthwhile thing. We display Taobao.com in English for the benefits of our customers by providing a money saving way to shop online '=>'Качественные товары на Таобао продаются по ценам значительно ниже, чем в европейских странах. LRISE.com предоставляет возможность русскоговорящим клиентам легко и выгодно приобрести дешевые товары в Китае.',
			'Convenient payment methods'=>'Безопасный платеж',
		...
		'zh'=>array(
			...
			'Cut half off your service fee '=>'半价服务费用',
			//帮助中心--焦点广告底部
			'Place Order and Make 1st Payment'=>'下单并付第一次款',
			'How to add money?'=>'如何充值？',
			'How to place orders?'=>'如何下订单？',
			'How much will you spend?'=>'你将花多少钱',
			'Submit delivery and Make 2nd Payment'=>'提交发送并付第二次款',
			'How to check order status?'=>'如何查看订单状态？',
			'How to submit delivery?'=>'如何提交发货？',
			'Compare shipping methods'=>'比较运输方式',
			'Wait for Your Parcel and Confirm Reception'=>'等待你的包裹并确认收货',
			'Track your package'=>'追踪您的包裹',
			'About Customs'=>'关于海关',
			...
			'Our professional customer support provides English service to our clients on 7 days a week. The unique quick order box on the website makes buying easier and orders can be handled in 24 hours, products can arrive within 7 days.'=>'我们专业的客户服务支持可以为客户提供全年24小时服务，在我们的网站上可以快速下单并且可以在24小时内处理您的订单,商品可以在7天内到达。',
			'Save money'=>'为您省钱',
			'Products on Taobao are sold at a lower price than in most western countries with good quality. Shopping in China is a very worthwhile thing. We display Taobao.com in English for the benefits of our customers by providing a money saving way to shop online '=>'许多产品在淘宝的售价比国外便宜并且质量好，在中国购物是个非常划算的事情。我们用英文展示淘宝为了给我们的客户提供省钱的方式去网购。',
			'Convenient payment methods'=>'方便快捷的支付方式',
